...
![Continuous Integration build in GitHub Actions](https://github.com/katner99/python-intermediate-rivercatchment/actions/workflows/main.yml/badge.svg)
Python that manages measurement data collected in river catchment surveys and campaigns.
